...
empiricalY=dpois(empiricalX, Slambda)
...
#Plot
ggplot(data, aes())+
  #geom_line(aes(exactX, exactY, color="Exata"), size=0.75)+ #Exact poisson distribution
  #geom_col(aes(exactX, exactY, color="Exata"), width=0.01)+ #Exact poisson distribution
  geom_point(aes(exactX, exactY, color="Exata"), size=1.5)+ #Exact poisson distribution
